### Preferential Attachment Tutorial (9/24/24)
...
1. `Preferential-Attachment.Rmd` is the main script with the tutorial and analysis of preferential attachment in simulated and replicated networks.
2. `drugnet.csv` is the main dataset used for the tutorial from the author's replication data.
3. `Preferential-Attachment.pdf` is a pdf rendering of the tutorial without any code. 
